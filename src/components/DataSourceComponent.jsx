...
const AzureBlobIcon = (props) => (
  <SvgIcon {...props} viewBox="0 0 24 24">
    ...
    <path
      fill="#0078D4"
      d="M12.33 6.87l-5.66 3.27-1.41-2.45 7.07-4.08 7.07 4.08-1.41 2.45-5.66-3.27zM4.26 14.13l1.41 2.45 5.66-3.27v-6.53l-7.07 4.08v3.27zm15.48 0l-7.07-4.08v6.53l5.66 3.27 1.41-2.45v-3.27zM12.33 17.13l-5.66-3.27-1.41 2.45 7.07 4.08 7.07-4.08-1.41-2.45-5.66 3.27z"
    />
  </SvgIcon>
);
...
const JdbcIcon = (props) => (
  <SvgIcon {...props} viewBox="0 0 24 24">
    ...
    <path
      fill="#757575"
      d="M12 3c-4.42 0-8 1.79-8 4v10c0 2.21 3.58 4 8 4s8-1.79 8-4V7c0-2.21-3.58-4-8-4zm0 2c3.31 0 6 1.34 6 3s-2.69 3-6 3-6-1.34-6-3 2.69-3 6-3zm0 14c-3.31 0-6-1.34-6-3v-1.54c1.39.9 3.59 1.54 6 1.54s4.61-.64 6-1.54V16c0 1.66-2.69 3-6 3z"
    />
  </SvgIcon>
);
  ...
  return (
    <Box>
      ...
      <Dialog
        ...
        maxWidth="sm"
      >
        <ColumnMapping setIsModeOpen={setIsModeOpen} />
      </Dialog>
    </Box>
  );
};
